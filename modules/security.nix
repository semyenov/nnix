  ...
  config = mkIf cfg.enable {
    ...
    boot = {
      kernel.sysctl = {
        ...
        # Note: On hardened kernels, this parameter is locked at boot to value 1
        # Applications like Ghostty can still use io_uring with appropriate privileges
        # "kernel.io_uring_disabled" = 0; # Disabled - locked on hardened kernels
